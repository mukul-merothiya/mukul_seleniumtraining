...
public class UNF_069 {
	...
	@Test
	public void verifyApplicationThrowErrorUponEnteringInvalidDetailsWhileAddingProduct() throws InterruptedException {
		...
		loginPOM1.sendMetaTagTitle("");//Invalid MetaTagTitle
		loginPOM1.clickDataTab();
		loginPOM1.sendModel("");//Invalod Model
...
//		selectProduct.selectByIndex(0);
		...
		loginPOM1.sendDiscountPrice("150");
