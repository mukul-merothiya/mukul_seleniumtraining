...
public class UniformComplexTCsPOM {

private WebDriver driver; 
	
	public UniformComplexTCsPOM(WebDriver driver) {
		this.driver = driver; 
	...
	private WebElement orderViewbtn;
	
	public void clickOrderViewEye()
	{
		this.orderViewbtn.click();
	}
	...
	public void clickOrderStatus()
	{
		...
		selectProduct.selectByVisibleText("Complete");
	}
